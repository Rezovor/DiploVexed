...
##++START-VEXED++##
          ...
          (val_div, ":cur_rents", 65),#Prosperity of 100 gives the default values
##++END-VEXED++##
...
##    ]),
  ...
  (48,
   [
##++START-VEXED++##
       (call_script, "script_randomly_make_prisoner_heroes_escape_from_party", "p_main_party", 20),
       (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
##         (party_slot_eq, ":center_no", slot_town_lord, "trp_player"),
         (assign, ":chance", 10),
         (try_begin),
...
##++START-VEXED++##
        ...
        (call_script, "script_change_player_party_morale", -0),
##++END-VEXED++##
