...
##Vexed Note Added##
  ("tutorial_map1","You are now viewing the overland map. Left-click on the map to move your party to that location, enter the selected town, or pursue the selected party. Time will pause on the overland map if your party is not moving, waiting or resting. To wait anywhere simply press and hold down the space bar. --DiploVexed-- Troop sizes are increased with this mod! You'll encounter large groups early on, please be prepared for this!"),
...
##++START-VEXED++##
  ("start_up_quest_message_1", "{s9} wants you to collect at least seventy (70) men from nearby villages. After you collect these men, find and speak with him. He is in the tavern at {s1}"),
##++END-VEXED++##
