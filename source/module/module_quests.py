...
##++START-VEXED++##
 ("collect_men", "Collect Five Men", 0,
  "{!}{s9} asked you to collect at least 70 men before you move against the bandits threatening the townsmen. You can recruit soldiers from villages as well as town taverns. You can find {s9} at the tavern in {s4} when you have think you have enough men."
  ), 
##++END-VEXED++##
  ...
  ##RGL ERROR FIX
 ("fix_rgl_error_quests", "Rgl error fix", 0, "{!}."
